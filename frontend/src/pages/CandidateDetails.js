										...
										<div className="col-xl-4 offset-xl-1 col-lg-4">
											<div className="information-and-contact">
												...
												<div className="buttons">
													...
													<a href="#" className="button cover-download">
														<i data-feather="download"></i>Cover Letter
													</a>
													<a href="#" className="button contact-download">
								...
								<div className="row">
									<div className="col-xl-7 col-lg-8">
										<div className="personal-information details-section">
											...
											<ul>
												<li>
													<span>Full Name:</span> Micheal N. Taylor
												</li>
												<li>
													<span>Father's Name:</span> Howard Armour
												</li>
												<li>
													<span>Mother's Name:</span> Megan Higbee
												</li>
												<li>
												...
												<li>
													<span>Address:</span> 2018 Nelm Street, Beltsville, VA
													20705
												</li>
											</ul>
										</div>
