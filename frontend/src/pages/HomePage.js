								...
								<ul className="dropdown-menu" aria-labelledby="navbarDropdown">
									...
									<li className="search-by">
										...
										<ul>
											<li>
												<a href="#">
													New York City <span>(508)</span>
												</a>
											</li>
											<li>
												<a href="#">
													Washington, D.C <span>(96)</span>
												</a>
											</li>
											<li>
												<a href="#">
													Chicago <span>(155)</span>
												</a>
											</li>
											<li>
												<a href="#">
													San Francisco <span>(24)</span>
												</a>
											</li>
											<li>
												<a href="#">
													Los Angeles <span>(268)</span>
												</a>
											</li>
											<li>
												<a href="#">
							...
							<div className="company-carousel owl-carousel">
								...
								<div className="company-wrap">
									<div className="thumb">
										<a href="#">
											<img
												src="/images/company/company-logo-2.png"
												className="img-fluid"
												alt
											/>
										</a>
								...
								<div className="company-wrap">
									<div className="thumb">
										<a href="#">
											<img
												src="/images/company/company-logo-3.png"
												className="img-fluid"
												alt
											/>
										</a>
								...
								<div className="company-wrap">
									<div className="thumb">
										<a href="#">
											<img
												src="/images/company/company-logo-4.png"
												className="img-fluid"
												alt
											/>
										</a>
					...
					<div className="row fact-items">
						<div className="col-md-3 col-sm-6">
							<div className="fact">
								...
								<p className="fact-number">
									<span className="count" data-form={0} data-to={12376} />
								</p>
						...
						<div className="col-md-3 col-sm-6">
							<div className="fact">
								...
								<p className="fact-number">
									<span className="count" data-form={0} data-to={89562} />
								</p>
						...
						<div className="col-md-3 col-sm-6">
							<div className="fact">
								...
								<p className="fact-number">
									<span className="count" data-form={0} data-to={28166} />
								</p>
						...
						<div className="col-md-3 col-sm-6">
							<div className="fact">
								...
								<p className="fact-number">
									<span className="count" data-form={0} data-to={1366} />
								</p>
						...
						<div className="row">
							...
							<div className="col-md-6">
								<div className="footer-social">
									...
									<select
										className="selectpicker select-language"
										id="select-country">
									...
									<div className="row">
										...
										<div className="col-xl-4 col-lg-4 order-lg-1">
											<p className="copyright-text">
												Copyright <a href="#">Oficiona</a> 2020, All right
												reserved
											</p>
										</div>
